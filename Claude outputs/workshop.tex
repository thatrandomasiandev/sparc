...
($2.37 \pm 0.26$ vs.\ $3.39 \pm 0.33$, $n{=}150$), % UNREPRODUCED — see RESULTS.md
and the paired advantage in
queries-to-threshold is $0.63$ queries, 95\% CI $[0.02, 1.25]$ % UNREPRODUCED — see RESULTS.md
--- positive but
...
\midrule
Regret after 10 queries & $3.67 \pm 0.34$ & $3.39 \pm 0.33$ & $\mathbf{2.37 \pm 0.26}$ & $0.25 \pm 0.07$ \\ % UNREPRODUCED — see RESULTS.md
Queries to threshold    & $6.08 \pm 0.34$ & $5.77 \pm 0.33$ & $\mathbf{5.14 \pm 0.33}$ & $2.21 \pm 0.21$ \\ % UNREPRODUCED — see RESULTS.md
...
$0.63$ queries, 95\% CI $[0.02, 1.25]$; % UNREPRODUCED — see RESULTS.md
on \textsc{random} by $0.94$, CI
...
threshold in $2.21$ queries against \textsc{voi}'s $5.14$, and ends at regret % UNREPRODUCED — see RESULTS.md
$0.25$ against $2.37$. % UNREPRODUCED — see RESULTS.md
Our acquisition captures roughly half of what is
